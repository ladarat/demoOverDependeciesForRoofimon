package com.project.demoroofimon.framework
...
class Matchers {
    ...
    fun viewIsVisibleAndContainsResourceText(@StringRes stringResource: Int) {
        onView(withText(stringResource)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
    }

    fun viewIsVisibleAndContainsText(stringResource: String) {
        onView(withText(stringResource)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
    }

    fun viewContainsResourceText(@IdRes viewId: Int, @StringRes stringResource: Int) {
